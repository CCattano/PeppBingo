...
namespace Pepp.Web.Apps.Bingo.Data.Repos.Token
{
    /// <summary>
    ...
    public class SecretRepo : BaseRepo, ISecretRepo
    {
        ...
        public async Task<List<SecretEntity>> GetSecrets<TEnum>(TEnum source) where TEnum : Enum
        {
            ...
            List<SecretEntity> valueDetailDescriptions =
                await base.Read<SecretEntity>(Sprocs.GetTokenSecretsBySource, @params);
        ...
        {
            public const string GetTokenSecretsBySource = "token.usp_SELECT_Secrets_BySource";
        }
    }
}
